...
export default function SubjectsScreen() {
  const { subjects: allSubjects, loading, error, selectedYear, selectedMonth } = useSubjects();
  console.log('Subjects screen - Year:', selectedYear, 'Month:', selectedMonth); // Add this  
